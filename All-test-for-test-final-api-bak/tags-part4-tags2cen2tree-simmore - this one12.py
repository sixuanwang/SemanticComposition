...
outputf = file('tags-centrality-simmore12-publication.txt', 'w')
outputf2 = file('tags-tree-simmore12-publication.txt', 'w')
'''
MAXLINE = 0 	
...
outputf = file('tags-centrality-simmore12-model.txt', 'w')
outputf2 = file('tags-tree-simmore12-model.txt', 'w')
lineid = 0
...
THRESHOLD_ADD_TREE_NOTE = 0.45 # whether close enough, the smaller the better
#RATIO_DISTANCE = 0.5 #no need ratio, bacause we are multiplying
RATIO_LEVENSHTEIN = 0.3
RATIO_SYNONYM = 0.0

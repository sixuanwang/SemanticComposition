...
outputfTag = file('tags-tag-10_3-dot3-s.txt', 'w')
outputfGrapgh = file('tags-graph-10_3-dot3-s.txt', 'w')
outputf = file('tags-centrality-10_3-dot3-s.txt', 'w')
outputf2 = file('tags-tree-10_3-dot3-s.txt', 'w')

...
outputf = file('tags-centrality-allsteps-with-threthold1w1q&lev-in-distance&blog.txt', 'w')
outputf2 = file('tags-tree-allsteps&ration1w1q&lev-in-distance&blog.txt', 'w')
lineid = 0

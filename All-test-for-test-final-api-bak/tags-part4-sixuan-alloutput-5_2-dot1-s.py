...
### old: graph = vertice is tag, arch is distance = 1/(frequency *2*3) from myTagPairs
...
outputfTag = file('tags-tag-5_2-dot1-s.txt', 'w')
outputfGrapgh = file('tags-graph-5_2-dot1-s.txt', 'w')
outputf = file('tags-centrality-5_2-dot1-s.txt', 'w')
outputf2 = file('tags-tree-5_2-dot1-s.txt', 'w')

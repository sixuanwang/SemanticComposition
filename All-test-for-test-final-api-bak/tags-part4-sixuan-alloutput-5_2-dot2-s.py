...
outputfTag = file('tags-tag-5_2-dot2-s.txt', 'w')
outputfGrapgh = file('tags-graph-5_2-dot2-s.txt', 'w')
outputf = file('tags-centrality-5_2-dot2-s.txt', 'w')
outputf2 = file('tags-tree-5_2-dot2-s.txt', 'w')
...
RATIO_LEVENSHTEIN = 0.2               # Similarity_Syntactic; the higher, the more significant
RATIO_SYNONYM = 0.2                   # Similarity_Semantic from wordnet; the higher, the more significant

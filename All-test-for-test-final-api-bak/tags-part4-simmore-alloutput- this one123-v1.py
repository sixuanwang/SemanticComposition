...
outputf = file('tags-centrality-simmore123-blogger.txt', 'w')
outputfGrapgh = file('tags-graph-simmore123-blogger.txt', 'w')
outputf2 = file('tags-tree-simmore123-blogger.txt', 'w')
...
dijkstra.printGraph(graph, outputfGrapgh)

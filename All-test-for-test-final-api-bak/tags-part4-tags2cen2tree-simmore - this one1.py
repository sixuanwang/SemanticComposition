...
outputf = file('tags-centrality-allsteps-with-threthold1w1q&levinsim&internet1.txt', 'w')
outputf2 = file('tags-tree-allsteps&ration1w1q&levinsim&internet1.txt', 'w')
lineid = 0

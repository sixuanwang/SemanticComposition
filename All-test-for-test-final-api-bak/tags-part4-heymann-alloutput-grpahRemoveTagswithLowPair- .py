...
Threthold_Tag_Set = 500                # remove the single tag with lower frequency 
Threthold_Tag_Pair = 500               # if greater than this number, the edge is connected (1) of two tags, otherwise, unconnected (0)

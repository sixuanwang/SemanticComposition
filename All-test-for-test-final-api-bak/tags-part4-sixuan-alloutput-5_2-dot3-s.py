...
outputfTag = file('tags-tag-5_2-dot3-s.txt', 'w')
outputfGrapgh = file('tags-graph-5_2-dot3-s.txt', 'w')
outputf = file('tags-centrality-5_2-dot3-s.txt', 'w')
outputf2 = file('tags-tree-5_2-dot3-s.txt', 'w')
...
Threthold_Tag_Pair = 2                # remove the tag pairs with lower frequency

Centrality_Percentage_2_Remove = 0.1  # remove the tail% of centrality order list
INIT_SIMILARITY_IN_GRAPH = 10          # initial value of he similarity, none similarity (0) infinity (10.0)
THRESHOLD_ADD_TREE_NOTE = 0.2         # whether close enough; if lower, child of root; 
RATIO_LEVENSHTEIN = 0.3               # Similarity_Syntactic; the higher, the more significant
RATIO_SYNONYM = 0.3                   # Similarity_Semantic from wordnet; the higher, the more significant

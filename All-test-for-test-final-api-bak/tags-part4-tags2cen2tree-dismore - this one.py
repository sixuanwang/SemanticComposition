...
outputf = file('tags-centrality-allsteps-with-threthold1w1q&lev-in-distance&internet.txt', 'w')
outputf2 = file('tags-tree-allsteps&ration1w1q&lev-in-distance&internet.txt', 'w')
lineid = 0
...
SYNONYM_YES_RATIO = 0.6
SYNONYM_NO_RATIO = 1.0

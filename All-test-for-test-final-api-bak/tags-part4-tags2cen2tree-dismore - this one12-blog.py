...
inputf = file('tags-init-blogger.txt')
outputf = file('tags-centrality-allsteps-with-threthold1w1q&lev-in-distance&blog12.txt', 'w')
outputf2 = file('tags-tree-allsteps&ration1w1q&lev-in-distance&blog12.txt', 'w')
lineid = 0

...
inputApis = 'Tag-signature-for-test.txt'
inputfTree = 'tags-tree-5_2-dot1-without.txt'
outputTestResults = file('CompositionResults-without.txt', 'w')

#outputfTree = file('treeeeee-test.txt', 'w')
'''
Api1 = {}
Api1['M'] = ['tm1', 'tm2']
...
print >> outputTestResults, "learntComposibleApis: ", learntComposibleApis
...
print >> outputTestResults,"\nCORRECT: ", "%d" %CORRECT
print >> outputTestResults, "MISSING: ", "%d" %MISSING
print >> outputTestResults, "INCORRECT: ", "%d" %INCORRECT
print >> outputTestResults, "RECALL: ", "%3.4f" %RECALL
print >> outputTestResults, "PRECISION: ", "%3.4f" %PRECISION
print >> outputTestResults, "F_MEASURE: ", "%3.4f" %F_MEASURE
